...
public class MyCenterPresent extends BasePresenter<IModel, MyCenterContract.ICenterView> implements MyCenterContract.ICenterPresent {
    ...
    public List<MultipleItem> getMenuBeans() {
        ...
        menuBeans.add(new MultipleItem(MultipleItem.ITEM_MENUS, new MyMenuBean("修改密码", 0, R.mipmap.modify_pwd, MyCenterContract.MODIFY_PWD, false)));
        menuBeans.add(new MultipleItem(MultipleItem.ITEM_DIVIDER, ""));
        ...
        menuBeans.add(new MultipleItem(MultipleItem.ITEM_MENUS, new MyMenuBean("关于我们", 0, R.mipmap.about_us, MyCenterContract.SET_ABOUT_TAG, false)));
